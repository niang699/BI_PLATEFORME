...
export const REPORTS: Report[] = [
  ...
  // ── Rapports RH ──────────────────────────────────────────────────────────
  {
    ...
    category: 'rh',
    url: 'http://localhost:8050/rh/dashboard',
    external: true,
    owner: 'Direction RH',
  ...
  },
  {
    ...
    category: 'rh',
    url: 'http://localhost:8050/rh/effectif',
    external: true,
    owner: 'Direction RH',
    lastRefresh: _ago(1 * 60 * 60 * 1000),
    status: 'live',
  ...
  },
  {
    ...
    category: 'rh',
    url: 'http://localhost:8050/rh/salaire',
    external: true,
    owner: 'Direction RH',
    lastRefresh: _ago(1 * 60 * 60 * 1000),
    status: 'live',
  ...
  },
  {
    ...
    category: 'rh',
    url: 'http://localhost:8050/rh/formation',
    external: true,
    owner: 'Direction RH',
    lastRefresh: _ago(1 * 60 * 60 * 1000),
    status: 'live',
